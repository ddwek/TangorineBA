...
Board board (true, "./zero_board_two_regular_cells_with_horizontal_diff_shapes");

int on_tick_cb (GtkWidget *widget, GdkFrameClock *frame_clock, gpointer data)
{
	static int i = 2, j = 3, cnt = 0;
	static shape_t shape_0 = SHAPE_SUN, shape_1 = SHAPE_MOON;
	bool finished = false;
	int ret = -1;
